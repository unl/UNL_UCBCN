...
class UNL_UCBCN_Subscription extends DB_DataObject 
{
    ...
    var $fb_fieldLabels = array('automaticapproval'=>'Automatically approve events (send to posted)?',
                                'expirationdate'=>'Expiration Date',
                                'name'=>'Subscription Title');
    var $fb_enumFields = array('automaticapproval');
    var $fb_enumOptions = array('automaticapproval'=>array('No (send to pending)','Yes (send to posted)'));
    var $fb_hiddenFields = array(	'datecreated',
                                    ...
                                    'timeperiod',
                                    'expirationdate');
    var $fb_linkElementTypes = array('automaticapproval'=>'radio');
	...
	function updateSubscribedCalendars($calendar_id)
	{
	    $updated = 0;
